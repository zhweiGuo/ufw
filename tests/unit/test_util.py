...
class UtilTestCase(unittest.TestCase):
    ...
    def test_get_services_proto(self):
        ...
        tests.unit.support.check_for_exception(
            self, socket.error, ufw.util.get_services_proto, "ufw-nonexistent"
        )
    ...
    def test_parse_port_proto(self):
        ...
        tests.unit.support.check_for_exception(
            self, ValueError, ufw.util.parse_port_proto, "7/tcp/udp"
        )
    ...
    def test_valid_address(self):
        ...
        for v in ["4", "any"]:
            for b in ["16a", "33", "-1"]:
                self.assertFalse(ufw.util.valid_address("192.168.0.1/%s" % b, v))

            for b in ["256", "s55", "-1"]:
                self.assertFalse(ufw.util.valid_address("192.168.0.%s" % b, v))
                self.assertFalse(ufw.util.valid_address("192.168.%s.1" % b, v))
                self.assertFalse(ufw.util.valid_address("192.%s.0.1" % b, v))
                self.assertFalse(ufw.util.valid_address("%s.168.0.1" % b, v))
                self.assertFalse(
                    ufw.util.valid_address("%s.%s.%s.%s" % (b, b, b, b), v)
                )
                self.assertFalse(
                    ufw.util.valid_address("192.168.0.1/255.255.255.%s" % b, v)
                )
                self.assertFalse(
                    ufw.util.valid_address("192.168.0.1/255.255.%s.255" % b, v)
                )
                self.assertFalse(
                    ufw.util.valid_address("192.168.0.1/255.%s.255.255" % b, v)
                )
                self.assertFalse(
                    ufw.util.valid_address("192.168.0.1/%s.255.255.255" % b, v)
                )
                self.assertFalse(
                    ufw.util.valid_address("192.168.0.1/%s.%s.%s.%s" % (b, b, b, b), v)
                )
                self.assertFalse(
                    ufw.util.valid_address("%s.168.0.1/255.255.255.%s" % (b, b), v)
                )
                self.assertFalse(
                    ufw.util.valid_address("192.%s.0.1/255.255.%s.255" % (b, b), v)
                )
                self.assertFalse(
                    ufw.util.valid_address("192.168.%s.1/255.%s.255.255" % (b, b), v)
                )
                self.assertFalse(
                    ufw.util.valid_address("192.168.0.%s/%s.255.255.255" % (b, b), v)
                )
                self.assertFalse(
        ...
        tests.unit.support.check_for_exception(
            self, ValueError, ufw.util.valid_address, "::1", "7"
        )
        ...
        for v in ["4", "any"]:
            ...
            self.assertTrue(ufw.util.valid_address("10.0.0.1/255.255.255.255", v))
            for i in range(0, 33):
                self.assertTrue(ufw.util.valid_address("192.168.0.1/%s" % i, v))
            for i in range(0, 256):
                self.assertTrue(
                    ufw.util.valid_address("192.168.0.1/255.255.255.%s" % i, v)
                )
                self.assertTrue(
                    ufw.util.valid_address("192.168.0.1/255.255.%s.255" % i, v)
                )
                self.assertTrue(
                    ufw.util.valid_address("192.168.0.1/255.%s.255.255" % i, v)
                )
                self.assertTrue(
                    ufw.util.valid_address("192.168.0.1/%s.255.255.255" % i, v)
                )
                self.assertTrue(
                    ufw.util.valid_address("192.168.0.1/%s.%s.%s.%s" % (i, i, i, i), v)
                )
    ...
    def test_normalize_address_valid_netmask_to_non_cidr(self):
        ...
        for i in range(1, 254):
            ...
            if i < 8:
                data.append(
                    (False, "192.168.0.0/255.%d.0.0" % i, "192.0.0.0/255.%d.0.0" % i)
                )
            elif i < 16:
                data.append(
                    (False, "192.168.0.0/255.%d.0.0" % i, "192.8.0.0/255.%d.0.0" % i)
                )
            elif i < 24:
                data.append(
                    (False, "192.168.0.0/255.%d.0.0" % i, "192.0.0.0/255.%d.0.0" % i)
                ...
                data.append(
                    (False, "192.168.0.0/255.%d.0.0" % i, "192.32.0.0/255.%d.0.0" % i)
                )
            elif i < 48:
                data.append(
                    (False, "192.168.0.0/255.%d.0.0" % i, "192.40.0.0/255.%d.0.0" % i)
                )
            elif i < 56:
                data.append(
                    (False, "192.168.0.0/255.%d.0.0" % i, "192.32.0.0/255.%d.0.0" % i)
                ...
                data.append(
                    (False, "192.168.0.0/255.%d.0.0" % i, "192.128.0.0/255.%d.0.0" % i)
                )
            elif i < 144:
                data.append(
                    (False, "192.168.0.0/255.%d.0.0" % i, "192.136.0.0/255.%d.0.0" % i)
                )
            elif i < 152:
                data.append(
                    (False, "192.168.0.0/255.%d.0.0" % i, "192.128.0.0/255.%d.0.0" % i)
                ...
                data.append(
                    (False, "192.168.0.0/255.%d.0.0" % i, "192.160.0.0/255.%d.0.0" % i)
                )
            elif i < 176:
                data.append(
                    (False, "192.168.0.0/255.%d.0.0" % i, "192.168.0.0/255.%d.0.0" % i)
                )
            elif i < 184:
                data.append(
                    (False, "192.168.0.0/255.%d.0.0" % i, "192.160.0.0/255.%d.0.0" % i)
            ...
            if i < 64:
                ...
                data.append(
                    (False, "192.168.0.0/%d.0.0.0" % i, "64.0.0.0/%d.0.0.0" % i)
                )
            elif i < 192:
                data.append(
                    (False, "192.168.0.0/%d.0.0.0" % i, "128.0.0.0/%d.0.0.0" % i)
                )
            else:
                data.append(
                    (False, "192.168.0.0/%d.0.0.0" % i, "192.0.0.0/%d.0.0.0" % i)
                )
    ...
    def test_normalize_address_ipv6_short_notation(self):
        ...
        data = [
            (
                True,
                "fe80:0000:0000:0000:0211:aaaa:bbbb:d54c",
                "fe80::211:aaaa:bbbb:d54c",
            ),
            (
                True,
                "2001:0db8:85a3:08d3:1319:8a2e:0370:734",
                "2001:db8:85a3:8d3:1319:8a2e:370:734",
            ),
        ]
        error_str = self._run_normalize_address(data)
    ...
    def test_normalize_address_invalid_netmask(self):
        ...
        for (v6, ip, expected) in data:
            tests.unit.support.check_for_exception(
                self, expected, ufw.util.normalize_address, ip, v6
            )
    ...
    def test_open_file_read(self):
        ...
        tests.unit.support.check_for_exception(
            self, IOError, ufw.util.open_file_read, tmp + "nonexistent"
        )
    ...
    def test_open_files(self):
        ...
        tests.unit.support.check_for_exception(
            self, IOError, ufw.util.open_files, tmp + "nonexistent"
        )
    ...
    def test_write_to_file(self):
        """Test write_to_file()"""
        tests.unit.support.check_for_exception(
            self, OSError, ufw.util.write_to_file, None, "foo"
        )
...
"""
    ...
    def test_under_ssh(self):
        ...
        tests.unit.support.check_for_exception(
            self, ValueError, ufw.util.under_ssh, "a"
        )
    ...
    def test__dotted_netmask_to_cidr(self):
        ...
        # Fill in gaps that can't be tested via other tests
        tests.unit.support.check_for_exception(
            self, ValueError, ufw.util._dotted_netmask_to_cidr, "255.255.255.255", True
        )
        tests.unit.support.check_for_exception(
            self, ValueError, ufw.util._dotted_netmask_to_cidr, "255.255.255.256", False
        )

    def test__cidr_to_dotted_netmask(self):
        """Test _cidr_to_dotted_netmask()"""
        tests.unit.support.check_for_exception(
            self, ValueError, ufw.util._cidr_to_dotted_netmask, "32", True
        )
        tests.unit.support.check_for_exception(
            self, ValueError, ufw.util._cidr_to_dotted_netmask, "33", False
        )
    ...
    def test_in_network(self):
        """Test in_network()"""
        for i in range(0, 33):
            self.assertTrue(ufw.util.in_network("10.2.0.1", "10.2.0.1/%d" % i, False))
        self.assertFalse(ufw.util.in_network("10.2.0.1", "10.2.0.0/32", False))
        self.assertTrue(ufw.util.in_network("11.0.0.1", "10.2.0.1/7", False))
        self.assertFalse(ufw.util.in_network("11.0.0.1", "10.2.0.1/8", False))
        tests.unit.support.check_for_exception(
            self, ValueError, ufw.util.in_network, "10.2.0.1", "10.2.0.1/33", False
        )
        tests.unit.support.check_for_exception(
            self, ValueError, ufw.util.in_network, "10.2.0.1234", "10.2.0.1/24", False
        )
        self.assertTrue(ufw.util.in_network("10.2.0.1", "0.0.0.0/0", False))
        self.assertTrue(ufw.util.in_network("10.2.0.1/26", "10.2.0.1/24", False))
        tests.unit.support.check_for_exception(
            self,
            ValueError,
            ufw.util.in_network,
        ...
        self.assertTrue(ufw.util.in_network("0.0.0.0", "10.2.0.1/24", False))

        for i in range(0, 129):
            self.assertTrue(ufw.util.in_network("ff80::1", "ff80::1/%d" % i, True))
        self.assertFalse(ufw.util.in_network("ff80::1", "ff80::0/128", True))
        self.assertTrue(ufw.util.in_network("ff81::1", "ff80::1/15", True))
        self.assertFalse(ufw.util.in_network("ff81::1", "ff80::1/16", True))
        tests.unit.support.check_for_exception(
            self, ValueError, ufw.util.in_network, "ff80::1", "ff80::1/129", True
        )
        tests.unit.support.check_for_exception(
            self, ValueError, ufw.util.in_network, "gf80::1", "ff80::1/64", True
        )
    ...
    def test_get_netfilter_capabilities(self):
        ...
        tests.unit.support.check_for_exception(
            self, OSError, ufw.util.get_netfilter_capabilities
        )
...
def test_main():  # used by runner.py
    tests.unit.support.run_unittest(UtilTestCase)
