...
$TESTPATH/usr/sbin/ufw --dry-run allow 25 >> $TESTTMP/result 2>&1 || exit 1
echo "9" >> $TESTTMP/result
$TESTPATH/usr/sbin/ufw --dry-run deny 25 >> $TESTTMP/result 2>&1 || exit 1
echo "10" >> $TESTTMP/result
$TESTPATH/usr/sbin/ufw --dry-run deny 1 >> $TESTTMP/result 2>&1 || exit 1
echo "11" >> $TESTTMP/result
$TESTPATH/usr/sbin/ufw --dry-run deny 65535 >> $TESTTMP/result 2>&1 || exit 1

echo "TESTING ARGS (allow/deny to/from)" >> $TESTTMP/result || exit 1
echo "12" >> $TESTTMP/result
$TESTPATH/usr/sbin/ufw --dry-run allow 25 from 192.168.0.1 to 192.168.0.2 >> $TESTTMP/result 2>&1 || exit 1
echo "13" >> $TESTTMP/result
$TESTPATH/usr/sbin/ufw --dry-run allow 25 from 192.168.0.1 >> $TESTTMP/result 2>&1 || exit 1
echo "14" >> $TESTTMP/result
$TESTPATH/usr/sbin/ufw --dry-run allow 25 to 192.168.0.2 >> $TESTTMP/result 2>&1 || exit 1

echo "15" >> $TESTTMP/result
$TESTPATH/usr/sbin/ufw --dry-run allow 25 to 192.168.0.0/24 >> $TESTTMP/result 2>&1 || exit 1
echo "16" >> $TESTTMP/result
$TESTPATH/usr/sbin/ufw --dry-run allow 25 to 192.168.0.0/32 >> $TESTTMP/result 2>&1 || exit 1
echo "17" >> $TESTTMP/result
$TESTPATH/usr/sbin/ufw --dry-run allow 25 to 192.168.0.0/12 >> $TESTTMP/result 2>&1 || exit 1
echo "18" >> $TESTTMP/result
$TESTPATH/usr/sbin/ufw --dry-run allow 25 to 0.0.0.0/0 >> $TESTTMP/result 2>&1 || exit 1
